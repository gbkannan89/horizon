                      ...
                      children: [
                        ...
                        Consumer<FinancialProvider>(
                          builder: (context, provider, child) {
                            ...
                            if (costs == null ||
                                provider.recurringFamilyCosts == 0) {
                              return const SizedBox.shrink();
                            }
                            final schooling = (costs['schooling'] ?? 0)
                                .toDouble();
                            final medicines = (costs['medicines'] ?? 0)
                                .toDouble();
                            final checkups = (costs['checkups'] ?? 0)
                                .toDouble();
                            final vaccinations = (costs['vaccinations'] ?? 0)
                                .toDouble();
                            final insurance = (costs['insurance'] ?? 0)
                                .toDouble();
                          ...
                          builder: (context, provider, child) {
                            if (provider.familyMembers.isEmpty) {
                              return const Padding(
                                ...
                                child: Text(
                                  'No family member profiles found.',
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 12),
                              const Text(
                                'Share access with your family. Share your invite code or join an existing household.',
                                style: TextStyle(
                                  color: Color(0xFF64748B),
                                  fontSize: 13,
                                  height: 1.4,
