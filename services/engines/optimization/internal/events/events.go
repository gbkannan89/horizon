...
type OptimizationGenerated struct{ BaseEvent; CandidatesEvaluated int; CandidatesValid int }
func NewOptimizationGenerated(id string, evaluated, valid int) OptimizationGenerated { return OptimizationGenerated{BaseEvent: NewBase("OptimizationGenerated", id), CandidatesEvaluated: evaluated, CandidatesValid: valid} }
